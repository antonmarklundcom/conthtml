...
Exit: `/guias/` + 10 guide URLs in the sitemap, titles ≤ 60 / descriptions 120–155, HowTo + FAQ JSON-LD on each, verify green, screenshots in `docs/screenshots/c2/`, PR merged.
