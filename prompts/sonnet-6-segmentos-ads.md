...
Exit: 9 URLs in the sitemap, homepage rubros cards and `/servicios/` link to them, verify green, screenshots in `docs/screenshots/c3/`, `docs/ads-campaigns.md` written, PR merged.
