...
Read `plan.md` FIRST, in full — plus §9 build log, `KNOWN-ISSUES.md`, `docs/lead-value.md` and
...
Exit: 5 `/en/` URLs in the sitemap with hreflang, verify green with the extended route contract, a test lead from `/en/contact/` logged with `lang=en`, screenshots in `docs/screenshots/c5/`, PR merged.
