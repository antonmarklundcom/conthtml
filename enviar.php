 ...
 *
 * Contract (plan §5.1.8), consumed by partials/lead-form.php and by B3's tools:
 *
...
/* Paraguayan numbers are 9–10 digits locally (0981 123 456) and 12 with the
   country code (+595 981 123 456). VenderCRM normalises the format; we only
   reject what plainly cannot be a phone number. */
