<?php
/**
 * Renders one segment page from content/segmentos.php: the eight rubro pages
 * under /contador-para/<slug>/ and /cambiar-de-contador/ (plan §6.6). Every
 * /contador-para/<slug>/index.php and /cambiar-de-contador/index.php is three
 * lines: require bootstrap, set $slug, require this file — the same pattern
 * templates/service.php and templates/tool.php use.
 *
 ...
 * content/lead-values.php['services'] (docs/lead-value.md — "the lead form
 * preset to the bundle's tier-A service"), so the whole lead value model C1
 * built resolves the tier, the CRM tag and the WhatsApp prefill with no new
 * entries needed there.
 *
 * New file, additive — not one of the hard-limited templates (plan §4.7).
 */
...
<main id="main">
  ...
  <!-- Solicitar: preset to the bundle's tier-A service (docs/lead-value.md). -->
