 ...
 * discipline templates/service.php and templates/tool.php use (plan §6.5.1).
 *
...
/* HowTo JSON-LD from the same $guide['steps'] array that renders the visible
   numbered list — one source, per plan §6.5.1. */
$howToSteps = [];
...
<main id="main">
  ...
  <!-- Cuándo conviene delegarlo (plan §6.5.1): the guide's own lead form, set
