<?php
/**
 * Site footer (4 columns as 1B), the WhatsApp button, and the closing scripts.
 * Every list comes from content/nav.php and content/site.php; an empty list —
 * tools before B3, socials until Anton supplies them — renders nothing at all
 * rather than an empty heading (plan §1.4, §4.13).
 *
