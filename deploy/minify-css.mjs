#!/usr/bin/env node
/**
 * Minifies assets/css/site.css (plan §6.4.2: "minified CSS copy produced by a
 * small script in deploy/ and committed"). No external dependencies — this
 * repo has no build step (plan §1.5), so the minifier is plain Node.
 *
