...
# actually renders (plan §6.4.2: "font subsetting"). Google Fonts' own "latin"
# and "latin-ext" variable-font files carry every glyph either subset can ever
# need (Vietnamese, IPA, historic Latin letters, ...); this site only ever
# renders Spanish text, guaraní amounts (₲, U+20B2) and a handful of
# typographic marks, so most of that is dead weight.
#
...
# below (rare for Spanish content) — it prints a comma-free failure if
